...
cursor = conn.cursor()
categories = ['Marketing, Business Managment, Database Managment, Business Stats, Application Devolpement']
for category in categories:
    cursor.execute(f'''CREATE TABLE IF NOT EXSITS {category.replace(" ","_")}(
...
marketing_questions = [
    ("What is marketing?", "A) Selling products", "B) Promoting products", "C) Managing finances", "D) None of the above", "B) Promoting products"),
...
database_mgmt_questions = [
    ("What is a database?", "A) A collection of files", "B) A collection of data", "C) A network of computers", "D) None of the above", "B) A collection of data"),
...
python_beginner_questions = [
    ("What is Python?", "A) A high-level programming language", "B) A database management system", "C) An operating system", "D) None of the above", "A) A high-level programming language"),
...
business_stats_questions = [
    ("What is statistics?", "A) A branch of mathematics", "B) A data analysis technique", "C) A probability theory", "D) None of the above", "A) A branch of mathematics"),
...
business_mgmt_questions = [
    ("What is management?", "A) Controlling resources", "B) Leading people", "C) Planning and organizing", "D) None of the above", "C) Planning and organizing"),
